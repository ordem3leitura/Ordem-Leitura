...
<section id="hero">
  ...
  <div class="hero-right">
    <div class="hero-emblem">
      ...
      <div class="emblem-tagline">Lemos · Fofocamos · Repetimos</div>
    </div>
...
<section id="sobre">
  <div class="sobre-inner">
    ...
    <div class="sobre-text reveal">
      ...
      <h2 class="section-heading">Um bando de leitoras que adora discordar (com muito carinho)</h2>
      ...
      <p>Todo mês, um livro. Todo encontro, uma discussão que começa na página e termina no mundo. Abertas a todas as perspectivas, a todos os gêneros literários.</p>
      <div class="sobre-pillars">
        ...
        <div class="pillar">
          ...
          <span class="pillar-desc">Sem posição certa ou errada. Só ideias,  café e boa companhia.</span>
        </div>
        <div class="pillar">
          <span class="pillar-icon">🌍</span>
        ...
        <div class="pillar">
          ...
          <span class="pillar-desc">Uma vez por mês, pessoalmente. O melhor jeito de terminar um bom livro.</span>
        </div>
      </div>
    </div>
  </div>
...
<section id="urna">
  <div class="urna-inner">
    ...
    <p style="font-size:13px;font-weight:300;color:#7A3050;line-height:1.8;max-width:560px;margin-bottom:2.5rem;">
      Cada membra indica os livros que deseja ler. A sorte decide qual história leva o grupo para viajar esse mês. Simples, justo e com um toque de drama.
    </p>
